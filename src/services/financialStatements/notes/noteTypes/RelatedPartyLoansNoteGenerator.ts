// ============================================================================
// RELATED PARTY LOANS NOTE GENERATOR
// ============================================================================
...
/**
 * Generates related party loans note with row tracking
 * Covers loans from related parties/entities (account 2100)
 */
export class RelatedPartyLoansNoteGenerator {
  ...
  /**
   * Generate related party loans note with row tracking
   * Uses account 2100 for related party long-term borrowings
   */
  static generateWithRowTracking(
    ...
    console.log(`=== RELATED PARTY LOANS NOTE ROW TRACKING: Starting at row ${tracker.currentRow} ===`);
    ...
    // 3. Detail Row
    notes.push(['', '', 'เงินกู้ยืมระยะยาวจากบุคคลที่เกี่ยวข้อง', '', '', '', totalAmount, '', 
    ...
    console.log(`Related Party Loans Note: Header rows: ${tracker.headerRows}, Year rows: ${tracker.yearHeaderRows}, Detail rows: ${tracker.detailRows}, Total rows: ${tracker.totalRows}`);
    return tracker;
  }
}
